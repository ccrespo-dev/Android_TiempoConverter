...
import com.ccl.tiempodam.ViewModel.ConverterViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ConverterScreen(
    // SI YA EXISTE LO RECUPERA Y NO LO CREA
    viewModel: ConverterViewModel = viewModel(),
    onButtonClick: () -> Unit
){
    // Observar las variables del viewModel
    val input by viewModel.celsiusInput.collectAsState()
    val result by viewModel.fahremheitResult.collectAsState()
